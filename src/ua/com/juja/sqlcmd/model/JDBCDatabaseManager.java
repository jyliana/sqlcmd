...
public class JDBCDatabaseManager implements DatabaseManager {
    ...
    public void connect(String database, String userName, String password) {
        try {
            ...
            throw new RuntimeException("Please add jdbc jar to the project.", e);
        }
        try {
            ...
            connection = null;
            throw new RuntimeException(String.format("Can't get connection for model: %s user: %s", database, userName), e);
        }
    }
